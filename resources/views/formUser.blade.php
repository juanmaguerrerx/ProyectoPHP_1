...
<head>
    ...
    <title>Agregar Operario | BungleBuilding S.L</title>
    ...
    <form method='POST' action="{{route('enviarOperario')}}">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="nombre" class="form-control" value="{{isset($datosFormulario['nombre']) ? $datosFormulario['nombre'] : ''}}" id="nombre" placeholder="Nombre">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="apellidos" class="form-control" id="apellidos" value="{{isset($datosFormulario['apellidos']) ? $datosFormulario['apellidos'] : ''}}" placeholder="Apellidos">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="correo" class="form-control" id="correo" value="{{isset($datosFormulario['correo']) ? $datosFormulario['correo'] : ''}}" placeholder="Email">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" name="contrasena" class="form-control" id="contrasena" value="{{isset($datosFormulario['contrasena']) ? $datosFormulario['contrasena'] : ''}}" placeholder="Contraseña">
